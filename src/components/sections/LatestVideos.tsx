      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6 sm:mb-8">
          <div className="text-center sm:text-left">
            <p className="font-accent text-lg sm:text-xl text-primary mb-1 sm:mb-2">
              Watch & cook along
            </p>
          ...
          <a
            ...
            className="text-primary font-medium inline-flex items-center justify-center sm:justify-start gap-2 hover:gap-3 transition-all"
          >
