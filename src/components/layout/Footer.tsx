...
export function Footer() {
  return (
    <footer className="bg-slate-blue text-parchment">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/recipes" className="text-parchment/70 hover:text-primary transition-colors text-sm sm:text-base">
                  All Recipes
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-parchment/70 hover:text-primary transition-colors text-sm sm:text-base">
                  About Lan
                </Link>
              </li>
              <li>
                <a
                  ...
                  className="text-parchment/70 hover:text-primary transition-colors text-sm sm:text-base"
                >
                  YouTube
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-parchment/10 rounded-lg hover:bg-secondary transition-colors"
                aria-label="YouTube"
              >
        ...
        <div className="border-t border-parchment/20 mt-6 sm:mt-8 pt-6 sm:pt-8 flex flex-col items-center gap-3 sm:gap-4 text-center">
          <p className="font-accent text-base sm:text-lg text-parchment">
