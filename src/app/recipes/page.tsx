  ...
  const filteredRecipes = useMemo(() => {
    return mockRecipes.filter((recipe) => {
      ...
      const matchesDifficulty =
        ...
        recipe.enhancedRecipe.difficulty === selectedDifficulty;
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="font-accent text-xl text-terracotta mb-2">Explore our collection</p>
          <h1 className="font-heading text-4xl font-bold text-charcoal">All Recipes</h1>
          <p className="mt-4 text-charcoal-light max-w-2xl mx-auto">
            Browse through our collection of delicious recipes. Each one comes with a video
            tutorial and AI-enhanced instructions.
          </p>
        </div>
