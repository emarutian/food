        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <p className="font-accent text-xl sm:text-2xl text-terracotta mb-2 sm:mb-4">
                Hi, I&apos;m Lan
              </p>
              ...
              <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4">
                <Link
                  href="/recipes"
                  className="bg-terracotta hover:bg-terracotta-dark text-white px-6 py-3 rounded-lg font-medium transition-colors inline-flex items-center justify-center gap-2"
                >
                  Browse Recipes
                ...
                <Link
                  href="/about"
                  className="border-2 border-charcoal text-charcoal hover:bg-charcoal hover:text-white px-6 py-3 rounded-lg font-medium transition-colors text-center"
                >
                  Meet Lan
                </Link>
              </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="bg-white/90 rounded-full p-3 sm:p-4 shadow-lg hover:scale-110 transition-transform">
                        <Play className="h-6 w-6 sm:h-8 sm:w-8 text-terracotta fill-terracotta" />
                      </div>
                    </div>
                    <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                      <span className="inline-block bg-terracotta text-white text-xs font-medium px-2 py-1 rounded mb-1 sm:mb-2">
                        Featured
                      </span>
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <Link
                    ...
                    className="mt-2 sm:mt-3 text-terracotta font-medium text-sm inline-flex items-center gap-1 hover:gap-2 transition-all"
                  >
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 text-center">
            <div>
              <div className="flex justify-center mb-1 sm:mb-2">
                <BookOpen className="h-5 w-5 sm:h-6 sm:w-6 text-terracotta" />
              </div>
            ...
            <div>
              <div className="flex justify-center mb-1 sm:mb-2">
                <Play className="h-5 w-5 sm:h-6 sm:w-6 text-terracotta" />
              </div>
            ...
            <div>
              <div className="flex justify-center mb-1 sm:mb-2">
                <Users className="h-5 w-5 sm:h-6 sm:w-6 text-terracotta" />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6 sm:mb-8">
            <div className="text-center sm:text-left">
              <p className="font-accent text-lg sm:text-xl text-terracotta mb-1 sm:mb-2">Fresh from my kitchen</p>
            ...
            <Link
              href="/recipes"
              className="text-terracotta font-medium inline-flex items-center justify-center sm:justify-start gap-1 hover:gap-2 transition-all"
            >
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-sage/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <p className="font-accent text-lg sm:text-xl text-terracotta mb-1 sm:mb-2">Join the family</p>
      ...
      <section className="py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <p className="font-accent text-lg sm:text-xl text-terracotta mb-1 sm:mb-2">Why cook with me?</p>
            <h2 className="font-heading text-2xl sm:text-3xl font-bold text-charcoal">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-terracotta/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Clock className="h-7 w-7 sm:h-8 sm:w-8 text-terracotta" />
              </div>
